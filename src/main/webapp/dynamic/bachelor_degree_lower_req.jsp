...
<html>
  <head>
  <meta charset="UTF-8">
    <title>lower requirement course Page</title>
  </head>
  <body>
  	<h1>lower requirement course Page</h1>
	
    <%@ page language="java" import="java.sql.*" %>
    <% try{
    	DriverManager.registerDriver(new org.postgresql.Driver());
    	String GET_STUDENT_QUERY = "select * from bachelor_degree_lower_req";
    	...
    	if (action != null && action.equals("insert")){
    		...
    		PreparedStatement pstmt = connection.prepareStatement("INSERT INTO bachelor_degree_lower_req VALUES (?,?)");
    	...
    	<table>
    		...
    		<tr>
    			<form action = "bachelor_degree_lower_req.jsp" method = "get">
