...
<html>
  <head>
  <meta charset="UTF-8">
    <title>upper core course Page</title>
  </head>
  <body>
  	<h1>upper core course Page</h1>
	
    <%@ page language="java" import="java.sql.*" %>
    <% try{
    	DriverManager.registerDriver(new org.postgresql.Driver());
    	String GET_STUDENT_QUERY = "select * from bachelor_degree_upper_core";
    	...
    	if (action != null && action.equals("insert")){
    		...
    		PreparedStatement pstmt = connection.prepareStatement("INSERT INTO bachelor_degree_upper_core VALUES (?,?)");
    	...
    	<table>
    		...
    		<tr>
    			<form action = "bachelor_degree_upper_core.jsp" method = "get">
