...
<html>
  <head>
  <meta charset="UTF-8">
    <title>same dept committee Page</title>
  </head>
  <body>
  	<h1>same dept committee Page</h1>
	
    <%@ page language="java" import="java.sql.*" %>
    <% try{
    	DriverManager.registerDriver(new org.postgresql.Driver());
    	String GET_STUDENT_QUERY = "select * from committee_same_dept";
    	...
    	if (action != null && action.equals("insert")){
    		...
    		PreparedStatement pstmt = connection.prepareStatement("INSERT INTO committee_same_dept VALUES (?,?)");
    	...
    	<table>
    		...
    		<tr>
    			<form action = "committee_same_dept.jsp" method = "get">
