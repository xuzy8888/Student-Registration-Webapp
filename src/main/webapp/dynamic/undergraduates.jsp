...
<html>
  <head>
  <meta charset="UTF-8">
    <title>undergrads student Page</title>
  </head>
  <body>
  	<h1>Undergraduates page</h1>
	
    <%@ page language="java" import="java.sql.*" %>
    <% try{
    	DriverManager.registerDriver(new org.postgresql.Driver());
    	String GET_STUDENT_QUERY = "select * from undergraduates";
    	...
    	if (action != null && action.equals("insert")){
    		...
    		PreparedStatement pstmt = connection.prepareStatement("INSERT INTO undergraduates VALUES (?,?,?,?,?)");
    		...
    		pstmt.setString(5, request.getParameter("bsms"));
    		pstmt.executeUpdate();
    		connection.commit();
    	...
    	<table>
    		...
    		<tr>
    			<form action = "undergraduates.jsp" method = "get">
    				...
    				<th><input value = "" name = "bsms" size="15"></th>
